...
{
    /// <inheritdoc />
    public partial class ReplaceOrdersWithTrips : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TravelersId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TripsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripUser", x => new { x.TravelersId, x.TripsId });
                    table.ForeignKey(
                        name: "FK_TripUser_AspNetUsers_TravelersId",
